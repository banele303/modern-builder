      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                <CardTitle>KITCHEN & BATHRROMS</CardTitle>
            ...
            <Card>
              ...
              <CardContent>
                <Image src="/cleaning/poolcleaning.png" alt="HVAC System" width={400} height={200} className="w-full h-auto max-w-[400px] max-h-[200px] rounded-md object-cover" />
