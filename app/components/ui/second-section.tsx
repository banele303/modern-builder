    ...
    return (
        ...
        <div>
           ...
           text-2xl md:text-4xl my-6 md:my-10 md:text-center px-[2rem] font-extrabold text-blue-500">
                ...
                Your Best Pressure washing & Remodeling Expects
            </h3>
           ...
           text-[16px]  my-6 md:my-10  text-bold text-gray-500"
                    >
                        With years of experience and a commitment to excellence, we&apos;re here to solve all  your Pressure washing and housing remodeling  needs.
                        <br />
                        <br />
           ...
           text-[16px] my-6 md:my-10  text-gray-500"
                ...
                <div className="relative  pt-5 px-[2rem] w-full h-full overflow-hidden">
                    <Image
                        src={"/building/about-hero.jpg"}
                        width={1920}
                        height={1080}
                        priority
                        alt="plumbing Image"
